...
- Remote access for the paid period **stops immediately** (your dedicated hostname stops resolving).
- Your slug and account record are kept — nobody else can take them; a future payment restores everything.
- Your self-hosted Mediary Scout instance is **unaffected** — it runs on your own machine; we only provide the tunnel.
...
Payments past 14 days are generally non-refundable, except: service unavailable for 72+ consecutive hours due to our fault; or the service is permanently shut down by us (pro-rated refund for unused time).
